...
// Theme color palettes for different templates
const THEME_COLORS = {
  "01": {
    primary: "#0d47a1",
    secondary: "#1e88e5",
...
const TemplateOne = ({ resumeData = {}, colorPalette, containerWidth, templateId = "01" }) => {
  const {
    profileInfo = {},
    contactInfo = {},
    education = [],
  ...
  // Get theme colors based on templateId
  const themeColors = THEME_COLORS[templateId] || DEFAULT_THEME;
    ...
    >
      ...
      {profileInfo.summary && (
        <div className="resume-section mb-3">
          <Title text="Professional Summary" color={themeColors.primary} />
      ...
      <div className="grid grid-cols-3 gap-8">
        ...
        <div className="col-span-2 space-y-4">
          {workExperience.length > 0 && (
            <div className="resume-section">
              <Title text="Work Experience" color={themeColors.primary} />
              <div className="space-y-6">
                {workExperience.map((exp, i) => (
                  <WorkExperience
                    ...
                    durationColor={themeColors.secondary}
                  />
                ))}
              </div>
            </div>
          ...
          {projects.length > 0 && (
            <div className="resume-section">
              <Title text="Projects" color={themeColors.primary} />
        ...
        <div className="col-span-1 space-y-6">
          {skills.length > 0 && (
            <div className="resume-section">
              <Title text="Skills" color={themeColors.primary} />
          ...
          {education.length > 0 && (
            <div className="resume-section">
              <Title text="Education" color={themeColors.primary} />
          ...
          {certifications.length > 0 && (
            <div className="resume-section">
              <Title text="Certifications" color={themeColors.primary} />
          ...
          {languages.length > 0 && (
            <div className="resume-section">
              <Title text="Languages" color={themeColors.primary} />
              <div className="flex flex-wrap gap-2">
          ...
          {interests.length > 0 && interests.some((i) => i) && (
            <div className="resume-section">
              <Title text="Interests" color={themeColors.primary} />
              <div className="flex flex-wrap gap-2">
                {interests.map((int, i) =>
                  int ? (
                    <span
